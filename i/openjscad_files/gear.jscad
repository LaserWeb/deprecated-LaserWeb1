// Involute spur gear builder jscad script. Licensed under the MIT license (http://opensource.org/licenses/mit-license.php). Copyright 2014 Dr. Rainer Hessmer
      ...
      function getParameterDefinitions() {
				return [
					...
					{ name: 'clearance', caption: 'Clearance (minimal distance between the apex of a tooth and the trough of the other gear):', type: 'float', initial: 0.05 },
					{ name: 'backlash', caption: 'Backlash (minimal distance between meshing gears):', type: 'float', initial: 0.05 },
					...
					{ name: 'wheel1ToothCount', caption: 'Gear 1 Teeth Count (n1 > 0: external gear; n1 = 0: rack; n1 < 0: internal gear):', type: 'int', initial: 30 },
					{ name: 'wheel1CenterHoleDiamater', caption: 'Gear 1 Center Hole Diameter (0 for no hole):', type: 'float', initial: 20 },
					{ name: 'wheel2ToothCount', caption: 'Gear 2 Teeth Count:', type: 'int', initial: 8 },
					{ name: 'wheel2CenterHoleDiamater', caption: 'Gear 2 Center Hole Diameter (0 for no hole):', type: 'float', initial: 4 },
